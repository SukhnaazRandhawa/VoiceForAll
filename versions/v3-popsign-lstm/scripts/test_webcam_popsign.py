...
# WEIGHTS_PATH = "../models/final_7_sign.keras"
# DATA_DIR = "../data"
# MAX_FRAMES = 60
# MIN_FRAMES = 10
# NUM_CLASSES = 7
...
# MODEL_PATH = "../models/final_7_sign_weights.npy"
# DATA_DIR = "../data"
# MAX_FRAMES = 60
# MIN_FRAMES = 10
# NUM_CLASSES = 7
...
# print("Loading label map...")
# label_map = np.load(os.path.join(DATA_DIR, "label_map_7signs.npy"), allow_pickle=True).item()
...
#     print("\n" + "=" * 50)
#     print("WEBCAM TESTING - PopSign V3 (7 Signs)")
#     print("=" * 50)
#     print("Controls:")
#     print("  SPACE - Start/Stop recording")
#     print("  Q     - Quit")
...
#             cv2.imshow('PopSign Test - V3 (7 Signs)', frame)
...
WEIGHTS_PATH = "../models/final_7_sign_weights.npy"
DATA_DIR = "../data"
MAX_FRAMES = 60
MIN_FRAMES = 10
NUM_CLASSES = 7
